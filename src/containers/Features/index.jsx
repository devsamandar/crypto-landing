  ...
  return (
    ...
    >
      ...
      <div className="container relative">
        <Title
          title="Why Choose Us"
          page="The most trusted way to buy or sell crypto currency"
          text="Here are the few reasons why you should choose us"
        />
          ...
          <div className="flex items-center gap-5 bg-white p-5 rounded-md shadow-slate-300">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-2">
                Advanced payment and processing technologies, fine-tuned from
                more than 3 years development
              </p>
            </div>
          </div>
          <div className="flex items-center gap-5 bg-white p-5 rounded-md shadow-slate-300">
